...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      ...
      <div class="container">
        <h1 class="h2">จัดการข้อมูลบริษัท</h1>
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#com<?php echo $row['company_id']; ?>">
                      รายละเอียด
                    </button>
                    </td>
                    
                    <td><a href="cancel_company.php?c4nstcn=<?php echo $row['company_id']; ?>" class="btn btn-secondary">ยกเลิกสถานะบริษัท</a></td>

                </tr>
                      <div class="modal fade" id="com<?php echo $row['company_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <p class="fs-6">ธนาคาร: <?php echo $row['bank_name'];?></p>
                              <p class="fs-6">เลขบัญชี: <?php echo $row['bank_number'];?></p>
                              <p class="fs-6">วันที่ลงทะเบียน: <?php echo $row['created_at'];?></p>
                              
                              <hr class="featurette-divider">
                              <p class="fs-6">โลโก้บริษัท</p>
                              <img class="img-thumbnail rounded mx-auto d-block" width="300" height="300" 
                              src="images/company/logo/<?php echo $row['company_image']; ?>" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
